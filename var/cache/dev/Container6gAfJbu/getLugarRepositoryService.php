...
// Returns the private 'App\Repository\LugarRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/LugarRepository.php';

return $this->privates['App\\Repository\\LugarRepository'] = new \App\Repository\LugarRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
